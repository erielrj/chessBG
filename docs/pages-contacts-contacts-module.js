...
let ContactsPage = class ContactsPage {
    ...
    ngOnInit() {
        ...
        // 8. Preencha os campos se usuario está logado
        if (this.contactForm) {
    ...
    contactSend() {
        ...
        // Salva no documento no firestore
        this.afs.collection('contacts').add(this.contactForm.value)
            .then(() => {
            //Exibe o feedback
            this.app.myAlert('Mensagem enviada', 'Seu contato foi enviado com suceso!<br><br> Obrigado', () => {
                // Reiniciar formulário após envio
